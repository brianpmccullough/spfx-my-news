...
import styles from './SpfxMyNews.module.scss';
import { escape } from '@microsoft/sp-lodash-subset';
var SpfxMyNews = /** @class */ (function (_super) {
    __extends(SpfxMyNews, _super);
    function SpfxMyNews() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SpfxMyNews.prototype.render = function () {
        ...
        return (React.createElement("section", { className: "".concat(styles.spfxMyNews, " ").concat(hasTeamsContext ? styles.teams : '') },
...
export default SpfxMyNews;
//# sourceMappingURL=SpfxMyNews.js.map